...
public class TransparentImageCollision {
    ...
    public class TestPane extends JPanel {
        ...
        public TestPane() {
            try {
                fly = ImageIO.read(new File("sprites/player.gif"));
//                fly = ImageIO.read(getClass().getResource("/sprites/enemy.gif"));
                spider = ImageIO.read(new File("sprites/Circles.gif"));
//                spider = ImageIO.read(getClass().getResource("/sprites/playerBullet.gif"));
        ...
        protected boolean collision(int x, int y) {
            ...
            if (((spiderPixel >> 24) & 0xFF) > 0 && ((flyPixel >> 24) & 0xFF) > 0) {
                collision = true;
